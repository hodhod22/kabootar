...
5. ~~**SH17/SH18**~~ ✅ subset + deepen (`jitMmapOk` mmap/exec dual-bind; loop8/loopN/arith-imm/bit-ops/shifts/unary/eq/ne/lt/gt/le/ge/test/je/jne/jmp/jl/jle/jg/jge/nop `os_mm_call`; `jit_from_ops` breddad i64-op-legalitet + ärlig `jitCanCompile`, `sh17_jit_ops_wide_exec_smoke`; `gcHostDeleteOk` host-GC dual-bind)
