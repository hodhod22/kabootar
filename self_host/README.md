...
Produktkompilatorn är `self_host/compile.kab`. Plan: **[docs/ROADMAP.md — Våg SH](../docs/ROADMAP.md)**. Nästa kod: SH28 `nollDocIsKab` (efter `nollLspIsKab`) och SH20–SH28 delete-gate deepen; språkparitet i `.kab`, inte `src/`.
