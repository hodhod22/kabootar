...
16. ~~**F10 AOT native-image policy**~~ ✅ (x64/arm64 ship/ret-op + emit/load/verify/write/read/loaded text, RWX reject); native machine-code deepen; `nollAotReady` still false
