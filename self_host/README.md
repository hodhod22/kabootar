...
10. **SH23** 🟡 SHA/HMAC/PRF/handshake/GCM/X25519/HTTPS-GET + RSA/ECDSA cert-verify + https URL-parse GET + TLS app-data record + HTTP 200 unwrap + http_fetch URL/record + 302 Location follow + :443 port + chunked decode + multi TLS app-data records + POST body + JSON POST + PUT/PATCH + HEAD/DELETE + OPTIONS/CONNECT + TRACE + UA/Bearer + http_fetch via Kab TLS unwrap + http_fetch_async-shaped Kab TLS + 302/301/303 follow + 307/308 preserve (`sh23_crypto_sha_eval_smoke`, `sh23_crypto_hmac_eval_smoke`, `sh23_crypto_tls_prf_eval_smoke`, `sh23_crypto_tls_hs_eval_smoke`, `sh23_crypto_tls_gcm_eval_smoke`, `sh23_crypto_x25519_eval_smoke`, `sh23_crypto_tls_https_eval_smoke`, `sh23_crypto_tls_cert_eval_smoke`, `sh23_crypto_tls_ecdsa_eval_smoke`, `sh23_crypto_http_get_eval_smoke`, `sh23_crypto_http_resp_eval_smoke`, `sh23_crypto_http_fetch_eval_smoke`); rustls-host kvar. **Nästa:** sluta använda rustls när live `http_fetch_async` går via Kab TLS
