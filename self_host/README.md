...
10. **SH23** 🟡 Kab TLS 1.3 SAN iPAddress length 11 rejected rustls P-256-peer `:28457` (`crypto_tls13_peer_n11.kab`); SAN iPAddress length 12 rejected rustls P-256-peer `:28457` (`crypto_tls13_peer_n12.kab`); SAN iPAddress length 13 rejected rustls P-256-peer `:28457` (`crypto_tls13_peer_n13.kab`); SAN iPAddress length 14 rejected rustls P-256-peer `:28457` (`crypto_tls13_peer_n14.kab`); generaliserad SAN-validator (`crypto_tls13_peer_san_gen`) konsoliderar logik med ~50% kodreduktion; rustls-host kvar; `cryptoHostDeleteOk` false. **Nästa:** [Just nu](../docs/ROADMAP.md#just-nu).
