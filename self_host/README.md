...
10. **SH23** 🟡 Kab TLS unwrap + loopback hex-TCP + query Location (`sh23_crypto_http_fetch_eval_smoke`); rustls-host kvar. **Nästa:** [Just nu](../docs/ROADMAP.md#just-nu).
