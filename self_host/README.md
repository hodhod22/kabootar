...
10. **SH23** 🟡 Kab TLS 1.3 SAN iPAddress length 11 rejected rustls P-256-peer `:28457` (`crypto_tls13_peer_n11.kab`); SAN iPAddress length 12 rejected rustls P-256-peer `:28457` (`crypto_tls13_peer_n12.kab`); rustls-host kvar; `cryptoHostDeleteOk` false. **Nästa:** [Just nu](../docs/ROADMAP.md#just-nu).
