...
**Roadmap (produktion):** [ROADMAP.md](ROADMAP.md) **Våg GP** — GP0–GP5 ✅; **GP6** (`anim`/`physics3`/`particles`/`ui`/`postfx`/`light`/`save`/`terrain`/`audio++`/`procgen`/`i18n`/`stats` ✅ subset; net/XR kvar); **GP7** editor a–g ✅ subset. Ship: [SHIP.md](SHIP.md).
