...
| Operatorer | `+ - * / %`, **`**`**, `== != < <= > >=`, **`in`** (membership; host + self-host + Kab-VM), `&& \|\|`, **`??`** (host + self-host + Kab-VM), **`+= -= *= /= %= &= |= ^= <<= >>= >>>= **=`** (inkl. **`n **= 2`**, **`o.x **= 2`**, **`xs[0] **= 2`**, **`this.n **= 2`**, **`super.n **= 2`**, **`o.a.b **= 2`**, **`xs[0].x **= 2`**, **`o.items[0] **= 2`** / **`o.items[0][0] **= 2`** / **`xs[0][0].x **= 2`** / **`o.items[0][0].x **= 2`** / **`xs[0][0] **= 2`** / **`xs[0][0][0] **= 2`** / **`n %= 7`** / **`o.x %= 7`** / **`xs[0] %= 7`** / **`this.n %= 7`** / **`super.n %= 7`** / **`o.a.b %= 7`** / **`xs[0].x %= 7`** / **`o.items[0] %= 7`** / **`o.items[0][0] %= 7`** / **`xs[0][0].x %= 7`** / **`o.items[0][0].x %= 7`** / **`xs[0][0] %= 7`** / **`xs[0][0][0] %= 7`** / **`n -= 2`** / **`o.x -= 2`** / **`xs[0] -= 2`** / **`this.n -= 2`** / **`super.n -= 2`** / **`o.a.b -= 2`** / **`xs[0].x -= 2`** / **`o.items[0] -= 2`** / **`o.items[0][0] -= 2`** / **`xs[0][0].x -= 2`** / **`o.items[0][0].x -= 2`** / **`xs[0][0] -= 2`** / **`xs[0][0][0] -= 2`** / **`n *= 3`** / **`n /= 2`**, **`n <<= 1`**, **`n >>= 1`**, **`n >>>= 1`**, **`o.x <<= 1`**, **`o.x >>= 1`**, **`o.x >>>= 1`**, **`xs[0] <<= 1`**, **`xs[0] >>= 1`**, **`xs[0] >>>= 1`**, **`this.n <<= 1`**, **`this.n >>= 1`**, **`this.n >>>= 1`**, **`super.n <<= 1`**, **`super.n >>= 1`**, **`super.n >>>= 1`**, **`o.a.b <<= 1`**, **`o.a.b >>= 1`**, **`o.a.b >>>= 1`**, **`xs[0].x <<= 1`**, **`xs[0].x >>= 1`**, **`xs[0].x >>>= 1`**, **`o.items[0] <<= 1`**, **`o.items[0] >>= 1`**, **`o.items[0] >>>= 1`**, **`o.items[0][0] <<= 1`**, **`o.items[0][0] >>= 1`**, **`o.items[0][0] >>>= 1`**, **`xs[0][0].x <<= 1`**, **`xs[0][0].x >>= 1`**, **`xs[0][0].x >>>= 1`**, **`o.items[0][0].x <<= 1`**, **`o.items[0][0].x >>= 1`**, **`o.items[0][0].x >>>= 1`**, **`xs[0][0] <<= 1`**, **`xs[0][0] >>= 1`**, **`xs[0][0] >>>= 1`**, **`xs[0][0][0] <<= 1`**, **`xs[0][0][0] >>= 1`**, **`xs[0][0][0] >>>= 1`**, **`xs[i] +=`**, **`xs[0] |=`**, **`xs[0] &=`**, **`xs[0] ^=`**, **`o.x +=`**, **`o.x &=`**, **`o.x |=`**, **`o.x ^=`**, **`this.n &=`**, **`this.n |=`**, **`this.n ^=`**, **`super.n |=`**, **`super.n &=`**, **`super.n ^=`**, **`o.a.b &=`**, **`o.a.b |=`**, **`o.a.b ^=`**, **`o.a.b +=`**, **`o.items[0] +=`**, **`o.items[0] &=`**, **`o.items[0] |=`**, **`o.items[0] ^=`**, **`o.items[0][0] +=`**, **`o.items[0][0] &=`**, **`o.items[0][0] |=`**, **`o.items[0][0] ^=`**, **`xs[0].x +=`**, **`xs[0].x &=`**, **`xs[0].x |=`**, **`xs[0].x ^=`**, **`xs[0][0].x +=`**, **`xs[0][0].x &=`**, **`xs[0][0].x |=`**, **`xs[0][0].x ^=`**, **`o.items[0][0].x +=`**, **`o.items[0][0].x &=`**, **`o.items[0][0].x |=`**, **`o.items[0][0].x ^=`**, **`xs[0][0] +=`**, **`xs[0][0] &=`**, **`xs[0][0] |=`**, **`xs[0][0] ^=`**, **`xs[0][0][0] +=`**, **`xs[0][0][0] &=`**, **`xs[0][0][0] |=`**, **`xs[0][0][0] ^=`** host + self-host + Kab-VM), **`&&= \|\|= ??=`** (inkl. **`o.x ||= `** / **`o.x &&=`** / **`o.x ??=`** / **`xs[0] ||= `** / **`xs[0] ??=`** / **`o.a.b ??=`** / **`o.items[0] ||= `** / **`xs[0].x ??=`** / **`xs[0][0] ||= `** / **`this.n ||= `** / **`o.items[0][0] ||= `** / **`xs[0][0].x ??=`** / **`super.n ||= `** / **`o.items[0][0].x ??=`** / **`xs[0][0][0] ||= `** / **`Child<T> super.n ||= `** host + self-host + Kab-VM), **`!`**, **`? :`** (host + self-host + Kab-VM), **`& \| ^ ~ << >> >>>`** |
...
| `fn*` / `yield` | generator functions | **`fn* gen() { yield 1; yield* [2, 3]; return 99 }`**, **`gen()`** → iterator, **`.next()`**; self-host + Kab-VM **`.next().value`** (`sh6_self_host_generator_yield_ok`); **`try/finally` i `fn*`** (`sh6_self_host_generator_try_finally_ok`); **`g.return` `finally`** (`sh6_self_host_generator_return_finally_ok`); **`try/finally` utan `catch`** (`sh6_self_host_generator_try_finally_no_catch_ok`); **`g.throw` `catch` sedan `finally`** (`sh6_self_host_generator_throw_catch_finally_ok`); **`member_set` i `catch` + `finally`** (`sh6_self_host_generator_throw_catch_member_finally_ok`); **`yield` i `catch` sedan `finally`** (`sh6_self_host_generator_throw_catch_yield_finally_ok`); **`g.next(v)` send in i `yield` i `catch`** (`sh6_self_host_generator_throw_catch_yield_send_finally_ok`); **`yield*` i `catch` + `finally`** (`sh6_self_host_generator_throw_catch_yield_star_finally_ok`); **`yield* inner()` i `catch` + `finally`** (`sh6_self_host_generator_throw_catch_yield_star_inner_finally_ok`); **send genom `yield* inner()` i `catch`** (`sh6_self_host_generator_throw_catch_yield_star_inner_send_finally_ok`); **nästlad `yield* mid()`/`inner()` i `catch` + `finally`** (`sh6_self_host_generator_throw_catch_yield_star_nested_finally_ok`); **send genom nästlad `yield* mid()`/`inner()` i `catch`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_finally_ok`); **`yield` i `finally` efter nästlad send** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_yield_finally_ok`); **`return` i `catch` kör `finally`-`yield` efter nästlad send** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_ok`); **completion **13** efter `finally`-`yield`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_done_ok`); **completion `done: true`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_done_flag_ok`); **`.next()` efter completion förblir `done: true`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_done_again_ok`); **extra `.next()` `value: null`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_done_null_ok`); **`g.throw` efter completion förblir `done: true`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_throw_done_ok`); **`g.return` efter completion förblir `done: true`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_method_return_done_ok`); **`g.return` efter completion `value: null`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_method_return_null_ok`); **`g.throw` efter completion `value: null`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_throw_null_ok`); **send in i `finally`-`yield` efter nästlad `return`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_send_ok`); **`return` i `finally` ersätter `catch`-`return`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_override_ok`); **`throw` i `finally` efter send ersätter `catch`-`return`** (`sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_throw_override_ok); **g.throw in i inally-yield** (sh6_self_host_generator_throw_catch_yield_star_nested_send_return_finally_throw_into_yield_ok); **nästlad try + g.throw in i inner finally-yield** (`sh6_self_host_generator_nested_try_throw_into_finally_yield_ok`); **nästlad try + g.throw in i inner try** (`sh6_self_host_generator_nested_try_throw_into_try_ok`); **nästlad try + g.return in i inner try** (`sh6_self_host_generator_nested_try_return_into_try_ok`); **nästlad try + g.return in i inner finally-yield** (`sh6_self_host_generator_nested_try_return_into_finally_yield_ok`); **nästlad try + yttre finally + g.throw** (`sh6_self_host_generator_nested_try_outer_finally_throw_ok`); **nästlad try + yttre finally + g.return** (`sh6_self_host_generator_nested_try_outer_finally_return_ok`); **g.return vid yttre finally-yield** (`sh6_self_host_generator_nested_try_return_into_outer_finally_yield_ok`); **g.throw vid yttre finally-yield** (`sh6_self_host_generator_nested_try_throw_into_outer_finally_yield_ok`); **g.throw vid inner finally-yield + yttre finally** (`sh6_self_host_generator_nested_try_throw_inner_finally_outer_finally_ok`); **g.return vid inner finally-yield + yttre finally** (`sh6_self_host_generator_nested_try_return_inner_finally_outer_finally_ok`); **g.next(v) send in i yttre finally-yield** (`sh6_self_host_generator_nested_try_outer_finally_send_ok`); **g.next(v) send in i inner finally-yield** (`sh6_self_host_generator_nested_try_inner_finally_send_ok`); **g.next(v) send in i inner try-yield** (`sh6_self_host_generator_nested_try_inner_try_send_ok`); **yield* i inner try + yttre finally** (`sh6_self_host_generator_nested_try_yield_star_outer_finally_ok`); **`g.throw` genom `yield*` i inner try + yttre finally** (`sh6_self_host_generator_nested_try_yield_star_throw_outer_finally_ok`); **`g.return` genom `yield*` i inner try + yttre finally** (`sh6_self_host_generator_nested_try_yield_star_return_outer_finally_ok`); **`g.next(v)` send genom `yield*` i inner try + yttre finally** (`sh6_self_host_generator_nested_try_yield_star_send_outer_finally_ok`); **send genom `yield*` när inner-`fn*` har `try/finally`** (`sh6_self_host_generator_nested_try_yield_star_inner_try_send_outer_finally_ok`); **`g.throw` genom `yield*` när inner-`fn*` har `try/finally`** (`sh6_self_host_generator_nested_try_yield_star_inner_try_throw_outer_finally_ok`); **`g.return` genom `yield*` när inner-`fn*` har `try/finally`** (`sh6_self_host_generator_nested_try_yield_star_inner_try_return_outer_finally_ok`); **send in i inner-`fn*`:s `finally`-`yield` via `yield*`** (`sh6_self_host_generator_nested_try_yield_star_inner_finally_send_outer_finally_ok`); **`g.throw` in i inner-`fn*`:s `finally`-`yield` via `yield*`** (`sh6_self_host_generator_nested_try_yield_star_inner_finally_throw_outer_finally_ok`); **`g.return` in i inner-`fn*`:s `finally`-`yield` via `yield*`** (`sh6_self_host_generator_nested_try_yield_star_inner_finally_return_outer_finally_ok`); **`g.next(v)` send in i yttre `finally`-`yield` efter `yield*`** (`sh6_self_host_generator_nested_try_yield_star_outer_finally_send_ok`); **`g.throw` vid yttre `finally`-`yield` efter `yield*`** (`sh6_self_host_generator_nested_try_yield_star_throw_into_outer_finally_yield_ok`); **`g.return` vid yttre `finally`-`yield` efter `yield*`** (`sh6_self_host_generator_nested_try_yield_star_return_into_outer_finally_yield_ok`); **nästlad `yield* mid()`/`inner()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_nested_outer_finally_ok`); **`g.throw` genom nästlad `yield* mid()`/`inner()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_nested_throw_outer_finally_ok`); **`g.return` genom nästlad `yield* mid()`/`inner()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_nested_return_outer_finally_ok`); **`g.next(v)` send genom nästlad `yield* mid()`/`inner()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_nested_send_outer_finally_ok`); **`yield*` av array i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_array_outer_finally_ok`); **`g.throw` genom `yield*` av array i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_array_throw_outer_finally_ok`); **`g.return` genom `yield*` av array i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_array_return_outer_finally_ok`); **`g.next(v)` send in i yttre `finally`-`yield` efter `yield*` av array** (`sh6_self_host_generator_nested_try_yield_star_array_outer_finally_send_ok`); **`g.throw` vid yttre `finally`-`yield` efter `yield*` av array** (`sh6_self_host_generator_nested_try_yield_star_array_throw_into_outer_finally_yield_ok`); **`g.return` vid yttre `finally`-`yield` efter `yield*` av array** (`sh6_self_host_generator_nested_try_yield_star_array_return_into_outer_finally_yield_ok`); **`yield*` av `{ next() }` i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_outer_finally_ok`); **`g.throw` genom `yield*` av `{ next() }` (utan `throw`) + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_outer_finally_ok`); **`g.return` genom `yield*` av `{ next() }` (utan `return`) + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_return_outer_finally_ok`); **`g.next(v)` send in i yttre `finally`-`yield` efter `yield*` av `{ next() }`** (`sh6_self_host_generator_nested_try_yield_star_custom_outer_finally_send_ok`); **`g.throw` vid yttre `finally`-`yield` efter `yield*` av `{ next() }`** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_into_outer_finally_yield_ok`); **`g.return` vid yttre `finally`-`yield` efter `yield*` av `{ next() }`** (`sh6_self_host_generator_nested_try_yield_star_custom_return_into_outer_finally_yield_ok`); **`g.throw` genom `yield*` av `{ next(), throw() }` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_method_outer_finally_ok`); **`g.return` genom `yield*` av `{ next(), return() }` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_return_method_outer_finally_ok`); **`g.next(v)` send genom `yield*` av `{ next() }` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_send_outer_finally_ok`); **`yield*` av `Symbol.iterator` i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_outer_finally_ok`); **`g.throw` genom `yield*` av `Symbol.iterator` (utan `throw`) + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_outer_finally_ok`); **`g.return` genom `yield*` av `Symbol.iterator` (utan `return`) + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_outer_finally_ok`); **`g.next(v)` send genom `yield*` av `Symbol.iterator` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_send_outer_finally_ok`); **`g.next(v)` send in i yttre `finally`-`yield` efter `yield*` av `Symbol.iterator`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_outer_finally_send_ok`); **`g.throw` vid yttre `finally`-`yield` efter `yield*` av `Symbol.iterator`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_into_outer_finally_yield_ok`); **`g.return` vid yttre `finally`-`yield` efter `yield*` av `Symbol.iterator`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_into_outer_finally_yield_ok`); **`g.throw` genom `yield*` av `Symbol.iterator` med `throw()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_method_outer_finally_ok`); **`g.return` genom `yield*` av `Symbol.iterator` med `return()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_method_outer_finally_ok`); **`g.throw` genom `yield*` av `{ next(), throw() }` där `throw()` kastar vidare** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_rethrows_outer_finally_ok`); **`g.throw` genom `yield*` av `Symbol.iterator` vars `throw()` kastar vidare** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_rethrows_outer_finally_ok`); **`g.return` genom `yield*` av `{ next(), return() }` där `return()` kastar** (`sh6_self_host_generator_nested_try_yield_star_custom_return_throws_outer_finally_ok`); **`g.return` genom `yield*` av `Symbol.iterator` vars `return()` kastar** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_throws_outer_finally_ok`)`)`)`)`)`)`)`)`)`)`)`)`)`)`); **`g.return` genom `yield*` i inner try + yttre finally** (`sh6_self_host_generator_nested_try_yield_star_return_outer_finally_ok`); **`g.next(v)` send genom `yield*` i inner try + yttre finally** (`sh6_self_host_generator_nested_try_yield_star_send_outer_finally_ok`); **send genom `yield*` när inner-`fn*` har `try/finally`** (`sh6_self_host_generator_nested_try_yield_star_inner_try_send_outer_finally_ok`); **`g.throw` genom `yield*` när inner-`fn*` har `try/finally`** (`sh6_self_host_generator_nested_try_yield_star_inner_try_throw_outer_finally_ok`); **`g.return` genom `yield*` när inner-`fn*` har `try/finally`** (`sh6_self_host_generator_nested_try_yield_star_inner_try_return_outer_finally_ok`); **send in i inner-`fn*`:s `finally`-`yield` via `yield*`** (`sh6_self_host_generator_nested_try_yield_star_inner_finally_send_outer_finally_ok`); **`g.throw` in i inner-`fn*`:s `finally`-`yield` via `yield*`** (`sh6_self_host_generator_nested_try_yield_star_inner_finally_throw_outer_finally_ok`); **`g.return` in i inner-`fn*`:s `finally`-`yield` via `yield*`** (`sh6_self_host_generator_nested_try_yield_star_inner_finally_return_outer_finally_ok`); **`g.next(v)` send in i yttre `finally`-`yield` efter `yield*`** (`sh6_self_host_generator_nested_try_yield_star_outer_finally_send_ok`); **`g.throw` vid yttre `finally`-`yield` efter `yield*`** (`sh6_self_host_generator_nested_try_yield_star_throw_into_outer_finally_yield_ok`); **`g.return` vid yttre `finally`-`yield` efter `yield*`** (`sh6_self_host_generator_nested_try_yield_star_return_into_outer_finally_yield_ok`); **nästlad `yield* mid()`/`inner()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_nested_outer_finally_ok`); **`g.throw` genom nästlad `yield* mid()`/`inner()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_nested_throw_outer_finally_ok`); **`g.return` genom nästlad `yield* mid()`/`inner()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_nested_return_outer_finally_ok`); **`g.next(v)` send genom nästlad `yield* mid()`/`inner()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_nested_send_outer_finally_ok`); **`yield*` av array i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_array_outer_finally_ok`); **`g.throw` genom `yield*` av array i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_array_throw_outer_finally_ok`); **`g.return` genom `yield*` av array i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_array_return_outer_finally_ok`); **`g.next(v)` send in i yttre `finally`-`yield` efter `yield*` av array** (`sh6_self_host_generator_nested_try_yield_star_array_outer_finally_send_ok`); **`g.throw` vid yttre `finally`-`yield` efter `yield*` av array** (`sh6_self_host_generator_nested_try_yield_star_array_throw_into_outer_finally_yield_ok`); **`g.return` vid yttre `finally`-`yield` efter `yield*` av array** (`sh6_self_host_generator_nested_try_yield_star_array_return_into_outer_finally_yield_ok`); **`yield*` av `{ next() }` i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_outer_finally_ok`); **`g.throw` genom `yield*` av `{ next() }` (utan `throw`) + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_outer_finally_ok`); **`g.return` genom `yield*` av `{ next() }` (utan `return`) + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_return_outer_finally_ok`); **`g.next(v)` send in i yttre `finally`-`yield` efter `yield*` av `{ next() }`** (`sh6_self_host_generator_nested_try_yield_star_custom_outer_finally_send_ok`); **`g.throw` vid yttre `finally`-`yield` efter `yield*` av `{ next() }`** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_into_outer_finally_yield_ok`); **`g.return` vid yttre `finally`-`yield` efter `yield*` av `{ next() }`** (`sh6_self_host_generator_nested_try_yield_star_custom_return_into_outer_finally_yield_ok`); **`g.throw` genom `yield*` av `{ next(), throw() }` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_method_outer_finally_ok`); **`g.return` genom `yield*` av `{ next(), return() }` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_return_method_outer_finally_ok`); **`g.next(v)` send genom `yield*` av `{ next() }` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_custom_send_outer_finally_ok`); **`yield*` av `Symbol.iterator` i inner `try` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_outer_finally_ok`); **`g.throw` genom `yield*` av `Symbol.iterator` (utan `throw`) + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_outer_finally_ok`); **`g.return` genom `yield*` av `Symbol.iterator` (utan `return`) + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_outer_finally_ok`); **`g.next(v)` send genom `yield*` av `Symbol.iterator` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_send_outer_finally_ok`); **`g.next(v)` send in i yttre `finally`-`yield` efter `yield*` av `Symbol.iterator`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_outer_finally_send_ok`); **`g.throw` vid yttre `finally`-`yield` efter `yield*` av `Symbol.iterator`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_into_outer_finally_yield_ok`); **`g.return` vid yttre `finally`-`yield` efter `yield*` av `Symbol.iterator`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_into_outer_finally_yield_ok`); **`g.throw` genom `yield*` av `Symbol.iterator` med `throw()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_method_outer_finally_ok`); **`g.return` genom `yield*` av `Symbol.iterator` med `return()` + yttre `finally`** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_method_outer_finally_ok`); **`g.throw` genom `yield*` av `{ next(), throw() }` där `throw()` kastar vidare** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_rethrows_outer_finally_ok`); **`g.throw` genom `yield*` av `Symbol.iterator` vars `throw()` kastar vidare** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_rethrows_outer_finally_ok`); **`g.return` genom `yield*` av `{ next(), return() }` där `return()` kastar** (`sh6_self_host_generator_nested_try_yield_star_custom_return_throws_outer_finally_ok`); **`g.return` genom `yield*` av `Symbol.iterator` vars `return()` kastar** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_throws_outer_finally_ok`)`)`)`)`)`)`)`)`)`)`)`)`)`)`); **`g.next(v)`** yield-resultat (`sh6_self_host_generator_next_send_ok`); **`yield*` send** (`sh6_self_host_yield_star_send_ok`); **`yield*` throw/return** (`sh6_self_host_yield_star_throw_ok`, `sh6_self_host_yield_star_return_ok`); **`yield*` throw → outer `catch`** (`sh6_self_host_yield_star_throw_outer_ok`); **nästlad `yield*` throw** (`sh6_self_host_yield_star_nested_throw_ok`); **nästlad `yield*` send** (`sh6_self_host_yield_star_nested_send_ok`); **nästlad `yield*` return** (`sh6_self_host_yield_star_nested_return_ok`); **nästlad `let x = yield*`** (`sh6_self_host_yield_star_nested_expr_ok`); **`let x = yield* inner()`** completion (`sh6_self_host_yield_star_expr_ok`); **`return 99`** completion (`sh6_self_host_generator_return_ok`); **`g.return(v)`** close (`sh6_self_host_generator_method_return_ok`); **`g.throw(e)`** resume `catch` (`sh6_self_host_generator_throw_catch_ok`); **`yield* [1, 2]`** (`sh6_self_host_yield_star_array_ok`); **`yield*` array throw → outer `catch`** (`sh6_self_host_yield_star_array_throw_ok`); **`yield*` array `g.return`** (`sh6_self_host_yield_star_array_return_ok`); **`yield*` `{ next() }`** (`sh6_self_host_yield_star_custom_next_ok`); **`yield*` custom `return`** (`sh6_self_host_yield_star_custom_return_ok`); **`yield*` custom `throw`** (`sh6_self_host_yield_star_custom_throw_ok`); **`yield*` custom send** (`sh6_self_host_yield_star_custom_send_ok`); **`yield*` custom `return` `done: true`** (`sh6_self_host_yield_star_custom_return_done_ok`); **`yield*` `Symbol.iterator`** (`sh6_self_host_yield_star_symbol_iterator_ok`); **`for of` `Symbol.iterator`** (`sh6_self_host_for_of_symbol_iterator_ok`); **`for of` `{ next }`** (`sh6_self_host_for_of_custom_next_ok`); **`o[Symbol.iterator]`** (`sh6_self_host_for_of_symbol_iterator_wellknown_ok`); **`{ next() {} }` + `fn*`** (`sh6_self_host_obj_method_and_generator_ok`); **iterator-`this`** (`sh6_self_host_obj_method_iter_this_ok`); **`for of` `this`-writeback** (`sh6_self_host_for_of_obj_method_this_ok`); **nästlad `{ next() {} }` i `fn`** (`sh6_self_host_for_of_nested_obj_method_ok`); **nästlad `{ next() {} }` i `fn*`** (`sh6_self_host_yield_star_nested_obj_method_ok`); **nästlad `"return"()` `this`** (`sh6_self_host_yield_star_nested_return_this_ok`); **nästlad `"throw"()` `this`** (`sh6_self_host_yield_star_nested_throw_this_ok`); **`throw` `done: true`** (`sh6_self_host_yield_star_throw_done_ok`); **`throw` `done: true` + `yield`** (`sh6_self_host_yield_star_throw_done_next_ok`); **`return` `done: true` + `yield`** (`sh6_self_host_yield_star_return_done_next_ok`); **`try/finally` i `fn*`** (`sh6_self_host_generator_try_finally_ok`); **`yield* inner()`** (`sh6_self_host_yield_star_generator_ok`); **`for x of gen()`** (`sh6_self_host_for_of_generator_ok`); **`break`/`return`/`throw` stänger gen** (`sh6_self_host_for_of_generator_break_ok`, `sh6_self_host_for_of_generator_return_ok`, `sh6_self_host_for_of_generator_throw_ok`); **`continue` i `for of gen()`** (`sh6_self_host_for_of_generator_continue_ok`) |
