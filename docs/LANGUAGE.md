...
| 10x | `with` + `is`/`is not` | ✅ host eval; self-host parse+emit; **`is`/`is not` kab-only**; **`with` bind** kab-only | `a is b` → `object_is` CALL; `with { v: 4 } as r { acc.n = r.v }` (`sh6_self_host_with_bind_ok` → **4**) |
| 10y | `using` | ✅ host eval; self-host parse+emit; **Kab-VM class `close()` writeback** | `using y = x` i `{ }` → `dispose`/`close` vid block-slut; alias `x = y` efter close. `sh6_self_host_using_class_close_writeback_ok` → **1** |
...
| 10ac | `async fn` / `async =>` | ✅ host eval; self-host parse+emit `fn_async` / **`arrow_async`**; **kab-only** sync-kropp + `promise_resolve` | `async fn add(a, b) { return a + b }; await add(2, 3)` → **5** (`sh6_self_host_async_fn_ok`). **`let f = async (n) => n + 1; await f(9)`** → **10** (`sh6_self_host_async_arrow_ok`). Inte rust `schedule_bytecode_async` på Kab-VM. Inte `async fn*`. |
...
| 10ev | `g.throw` genom `yield*` av `{ next(), throw() }` där `throw()` är `done: true` | ✅ **kab-only** | `throw()` `{ value: e, done: true }` avslutar `yield*` utan `catch`; inner `yield 9` två gånger, yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_outer_finally_ok` → **1998**). Inte `async fn*`. |
| 10ew | femte `.next()` efter `throw()` `done: true` | ✅ **kab-only** | samma kedja; yttre `finally` `return 4` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_outer_finally_return_ok` → **19984**). Inte `async fn*`. |
| 10ex | `g.throw` genom `yield*` av `Symbol.iterator` vars `throw()` är `done: true` | ✅ **kab-only** | factory-iterator `throw()` `{ value: e, done: true }` avslutar `yield*` utan `catch`; inner `yield 9` två gånger, yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_outer_finally_ok` → **1998**). Inte `async fn*`. |
| 10ey | femte `.next()` efter `Symbol.iterator` `throw()` `done: true` | ✅ **kab-only** | samma kedja; yttre `finally` `return 4` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_outer_finally_return_ok` → **19984**). Inte `async fn*`. |
| 10ez | `g.return` genom `yield*` av `{ next(), return() }` där `return()` är `done: true` | ✅ **kab-only** | `return()` `{ value: v, done: true }` avslutar `yield*` utan `catch`; inner `yield 9` två gånger, yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_outer_finally_ok` → **1998**). Inte `async fn*`. |
| 10fa | femte `.next()` efter `return()` `done: true` | ✅ **kab-only** | samma kedja; yttre `finally` `return 4` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_outer_finally_return_ok` → **19984**). Inte `async fn*`. |
| 10fb | `g.return` genom `yield*` av `Symbol.iterator` vars `return()` är `done: true` | ✅ **kab-only** | factory-iterator `return()` `{ value: v, done: true }` avslutar `yield*` utan `catch`; inner `yield 9` två gånger, yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_outer_finally_ok` → **1998**). Inte `async fn*`. |
| 10fc | femte `.next()` efter `Symbol.iterator` `return()` `done: true` | ✅ **kab-only** | samma kedja; yttre `finally` `return 4` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_outer_finally_return_ok` → **19984**). Inte `async fn*`. |
| 10fd | `g.next(v)` send in i inner `finally`-`yield` efter `throw()` `done: true` | ✅ **kab-only** | `let x = yield 9; return x` efter `throw()` `{ done: true }`; `g.next(3)` → inner `yield 9` två gånger, yttre `yield 8`, femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_inner_finally_send_ok` → **19981**). Inte `async fn*`. |
| 10fe | `g.next(v)` send in i inner `finally`-`yield` efter `return()` `done: true` | ✅ **kab-only** | samma kedja med `g.return(4)` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_inner_finally_send_ok` → **19981**). Inte `async fn*`. |
| 10ff | `g.next(v)` send in i inner `finally`-`yield` efter `Symbol.iterator` `throw()` `done: true` | ✅ **kab-only** | factory-iterator `throw()` `{ done: true }` + `g.next(3)` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_inner_finally_send_ok` → **19981**). Inte `async fn*`. |
| 10fg | `g.next(v)` send in i inner `finally`-`yield` efter `Symbol.iterator` `return()` `done: true` | ✅ **kab-only** | factory-iterator `return()` `{ done: true }` + `g.next(3)` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_inner_finally_send_ok` → **19981**). Inte `async fn*`. |
| 10fh | `g.throw` in i inner `finally`-`yield` efter `throw()` `done: true` | ✅ **kab-only** | `g.throw(4)` avslutar `yield*`; `g.throw(3)` vid inner `yield 9` ger tre nior (**1999**) (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_inner_finally_throw_ok` → **1999**). Inte `async fn*`. |
| 10fi | femte `.next()` efter `g.throw` in i inner `finally`-`yield` | ✅ **kab-only** | efter **1999**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_inner_finally_throw_next_ok` → **19998**). Inte `async fn*`. |
| 10fj | `g.throw` in i inner `finally`-`yield` efter `return()` `done: true` | ✅ **kab-only** | `g.return(4)` avslutar `yield*`; `g.throw(3)` vid inner `yield 9` ger **1998** (1, 9, 9, 8) (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_inner_finally_throw_ok` → **1998**). Inte `async fn*`. |
| 10fk | femte `.next()` efter `g.throw` efter `return()` `done: true` | ✅ **kab-only** | efter **1998**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_inner_finally_throw_next_ok` → **19981**). Inte `async fn*`. |
| 10fl | `g.throw` in i inner `finally`-`yield` efter `Symbol.iterator` `throw()` `done: true` | ✅ **kab-only** | factory-iterator `throw()` `{ done: true }`; `g.throw(3)` vid inner `yield 9` ger tre nior (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_inner_finally_throw_ok` → **1999**). Inte `async fn*`. |
| 10fm | femte `.next()` efter `Symbol.iterator` `throw()` `done: true` + inner `g.throw` | ✅ **kab-only** | efter **1999**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_inner_finally_throw_next_ok` → **19998**). Inte `async fn*`. |
| 10fn | `g.throw` in i inner `finally`-`yield` efter `Symbol.iterator` `return()` `done: true` | ✅ **kab-only** | factory-iterator `return()` `{ done: true }`; `g.throw(3)` vid inner `yield 9` ger **1998** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_inner_finally_throw_ok` → **1998**). Inte `async fn*`. |
| 10fo | femte `.next()` efter `Symbol.iterator` `return()` `done: true` + inner `g.throw` | ✅ **kab-only** | efter **1998**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_inner_finally_throw_next_ok` → **19981**). Inte `async fn*`. |
| 10fp | `g.return` in i inner `finally`-`yield` efter `throw()` `done: true` | ✅ **kab-only** | `g.throw(4)` avslutar `yield*`; `g.return(3)` vid inner `yield 9` ger **1998** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_inner_finally_return_ok` → **1998**). Inte `async fn*`. |
| 10fq | femte `.next()` efter `g.return` efter `throw()` `done: true` | ✅ **kab-only** | efter **1998**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_inner_finally_return_next_ok` → **19981**). Inte `async fn*`. |
| 10fr | `g.return` in i inner `finally`-`yield` efter `Symbol.iterator` `throw()` `done: true` | ✅ **kab-only** | factory-iterator `throw()` `{ done: true }`; `g.return(3)` vid inner `yield 9` ger **1998** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_inner_finally_return_ok` → **1998**). Inte `async fn*`. |
| 10fs | femte `.next()` efter `Symbol.iterator` `throw()` `done: true` + inner `g.return` | ✅ **kab-only** | efter **1998**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_inner_finally_return_next_ok` → **19981**). Inte `async fn*`. |
| 10ft | `g.return` in i inner `finally`-`yield` efter `return()` `done: true` | ✅ **kab-only** | `g.return(4)` avslutar `yield*`; `g.return(3)` vid inner `yield 9` ger completion **3**; fjärde `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_inner_finally_return_ok` → **1931**). Inte `async fn*`. |
| 10fu | femte `.next()` efter `g.return` efter `return()` `done: true` | ✅ **kab-only** | efter **1931**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_inner_finally_return_next_ok` → **19311**). Inte `async fn*`. |
| 10fv | `g.return` in i inner `finally`-`yield` efter `Symbol.iterator` `return()` `done: true` | ✅ **kab-only** | factory-iterator `return()` `{ done: true }`; `g.return(3)` vid inner `yield 9` ger completion **3**; fjärde `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_inner_finally_return_ok` → **1931**). Inte `async fn*`. |
| 10fw | femte `.next()` efter `Symbol.iterator` `return()` `done: true` + inner `g.return` | ✅ **kab-only** | efter **1931**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_inner_finally_return_next_ok` → **19311**). Inte `async fn*`. |
| 10fx | `throw()` `{ done: false }` fortsätter `yield*` | ✅ **kab-only** | `g.throw(4)` ger **4**; nästa `it.next` ger **2**; inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_ok` → **1429**). Inte `async fn*`. |
| 10fy | femte `.next()` efter `throw()` `{ done: false }` fortsätter `yield*` | ✅ **kab-only** | efter **1429**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_next_ok` → **14298**). Inte `async fn*`. |
| 10fz | `Symbol.iterator` `throw()` `{ done: false }` fortsätter `yield*` | ✅ **kab-only** | factory-iterator `throw()` `{ done: false }`; nästa `it.next` ger **2**; inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_ok` → **1429**). Inte `async fn*`. |
| 10ga | femte `.next()` efter `Symbol.iterator` `throw()` `{ done: false }` fortsätter `yield*` | ✅ **kab-only** | efter **1429**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_next_ok` → **14298**). Inte `async fn*`. |
| 10gb | `return()` `{ done: false }` avslutar `yield*` | ✅ **kab-only** | `g.return(4)` ger **4**; senare `it.next` (**2**) körs inte; inner `yield 9`, yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_false_continue_ok` → **1498**). Inte `async fn*`. |
| 10gc | femte `.next()` efter `return()` `{ done: false }` avslutar `yield*` | ✅ **kab-only** | efter **1498**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_false_continue_next_ok` → **14981**). Inte `async fn*`. |
| 10gd | `Symbol.iterator` `return()` `{ done: false }` avslutar `yield*` | ✅ **kab-only** | factory-iterator `return()` `{ done: false }`; senare `it.next` (**2**) körs inte; inner `yield 9`, yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_false_continue_ok` → **1498**). Inte `async fn*`. |
| 10ge | femte `.next()` efter `Symbol.iterator` `return()` `{ done: false }` avslutar `yield*` | ✅ **kab-only** | efter **1498**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_false_continue_next_ok` → **14981**). Inte `async fn*`. |
| 10gf | `g.throw` in i fortsatt `yield*` efter `throw()` `{ done: false }` | ✅ **kab-only** | efter **1**, **4**, **2**; andra `g.throw(3)` delegeras till `throw()` `{ done: false }` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_throw_ok` → **1423**). Inte `async fn*`. |
| 10gg | femte `.next()` efter andra `g.throw` in i fortsatt `yield*` | ✅ **kab-only** | efter **1423**; `it.next` ger **2** igen (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_throw_next_ok` → **14232**). Inte `async fn*`. |
| 10gh | `g.throw` in i fortsatt `yield*` efter `Symbol.iterator` `throw()` `{ done: false }` | ✅ **kab-only** | factory-iterator; andra `g.throw(3)` delegeras (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_throw_ok` → **1423**). Inte `async fn*`. |
| 10gi | femte `.next()` efter andra `g.throw` via `Symbol.iterator` | ✅ **kab-only** | efter **1423**; `it.next` ger **2** igen (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_throw_next_ok` → **14232**). Inte `async fn*`. |
| 10gj | `g.return` in i fortsatt `yield*` efter `throw()` `{ done: false }` | ✅ **kab-only** | efter **1**, **4**, **2**; `g.return(3)` utan iterator-`return` ger inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_return_ok` → **1429**). Inte `async fn*`. |
| 10gk | femte `.next()` efter `g.return` in i fortsatt `yield*` | ✅ **kab-only** | efter **1429**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_return_next_ok` → **14298**). Inte `async fn*`. |
| 10gl | `g.return` in i fortsatt `yield*` efter `Symbol.iterator` `throw()` `{ done: false }` | ✅ **kab-only** | factory-iterator utan `return`; `g.return(3)` ger inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_return_ok` → **1429**). Inte `async fn*`. |
| 10gm | femte `.next()` efter `g.return` via `Symbol.iterator` in i fortsatt `yield*` | ✅ **kab-only** | efter **1429**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_return_next_ok` → **14298**). Inte `async fn*`. |
| 10gn | `g.return` in i fortsatt `yield*` med iterator-`return()` `{ done: false }` | ✅ **kab-only** | efter **1**, **4**, **2**; `g.return(3)` delegeras och yieldar **3** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_return_method_ok` → **1423**). Inte `async fn*`. |
| 10go | femte `.next()` efter `g.return` med iterator-`return()` `{ done: false }` | ✅ **kab-only** | efter **1423**; `yield*` avslutas; inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_return_method_next_ok` → **14239**). Inte `async fn*`. |
| 10gp | `g.return` via `Symbol.iterator` in i fortsatt `yield*` med iterator-`return()` `{ done: false }` | ✅ **kab-only** | factory-iterator; `g.return(3)` yieldar **3** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_return_method_ok` → **1423**). Inte `async fn*`. |
| 10gq | femte `.next()` efter `g.return` via `Symbol.iterator` med iterator-`return()` | ✅ **kab-only** | efter **1423**; inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_return_method_next_ok` → **14239**). Inte `async fn*`. |
| 10gr | sjätte `.next()` efter `g.return` med iterator-`return()` `{ done: false }` | ✅ **kab-only** | efter **14239**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_return_method_next6_ok` → **142398**). Inte `async fn*`. |
| 10gs | sjätte `.next()` efter `g.return` via `Symbol.iterator` med iterator-`return()` | ✅ **kab-only** | efter **14239**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_return_method_next6_ok` → **142398**). Inte `async fn*`. |
| 10gt | `g.next(v)` send in i fortsatt `yield*` efter `throw()` `{ done: false }` | ✅ **kab-only** | `it.next(7)` efter `throw()` `{ done: false }` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_ok` → **1479**). Inte `async fn*`. |
| 10gu | femte `.next()` efter send in i fortsatt `yield*` | ✅ **kab-only** | efter **1479**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_next_ok` → **14798**). Inte `async fn*`. |
| 10gv | `g.next(v)` send via `Symbol.iterator` in i fortsatt `yield*` efter `throw()` `{ done: false }` | ✅ **kab-only** | factory-iterator; `it.next(7)` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_ok` → **1479**). Inte `async fn*`. |
| 10gw | femte `.next()` efter `Symbol.iterator`-send in i fortsatt `yield*` | ✅ **kab-only** | efter **1479**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_next_ok` → **14798**). Inte `async fn*`. |
| 10gx | `g.next(v)` send efter `return()` `{ done: false }` som avslutar `yield*` | ✅ **kab-only** | `g.return(4)` sen `g.next(7)` kör inte `it.next`; inner `yield 9`, yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_false_continue_send_ok` → **1498**). Inte `async fn*`. |
| 10gy | femte `.next()` efter send som inte återupptar `it.next` | ✅ **kab-only** | efter **1498**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_return_done_false_continue_send_next_ok` → **14981**). Inte `async fn*`. |
| 10gz | `g.next(v)` send via `Symbol.iterator` efter `return()` `{ done: false }` som avslutar `yield*` | ✅ **kab-only** | factory-iterator; `g.next(7)` kör inte `it.next` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_false_continue_send_ok` → **1498**). Inte `async fn*`. |
| 10ha | femte `.next()` efter `Symbol.iterator`-send som inte återupptar `it.next` | ✅ **kab-only** | efter **1498**; femte `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_return_done_false_continue_send_next_ok` → **14981**). Inte `async fn*`. |
| 10hb | andra `g.throw` in i fortsatt `yield*` efter `g.next(v)` send | ✅ **kab-only** | efter **1**, **4**, **7**; `g.throw(3)` delegeras (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_throw_ok` → **1473**). Inte `async fn*`. |
| 10hc | femte `.next(v)` efter andra `g.throw` efter send | ✅ **kab-only** | efter **1473**; `g.next(2)` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_throw_next_ok` → **14732**). Inte `async fn*`. |
| 10hd | andra `g.throw` via `Symbol.iterator` efter `g.next(v)` send | ✅ **kab-only** | factory-iterator; `g.throw(3)` delegeras (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_throw_ok` → **1473**). Inte `async fn*`. |
| 10he | femte `.next(v)` efter andra `g.throw` via `Symbol.iterator` efter send | ✅ **kab-only** | efter **1473**; `g.next(2)` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_throw_next_ok` → **14732**). Inte `async fn*`. |
| 10hf | `g.return` in i fortsatt `yield*` efter `g.next(v)` send utan iterator-`return` | ✅ **kab-only** | efter **1**, **4**, **7**; `g.return(3)` ger inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_ok` → **1479**). Inte `async fn*`. |
| 10hg | femte `.next()` efter `g.return` efter send utan iterator-`return` | ✅ **kab-only** | efter **1479**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_next_ok` → **14798**). Inte `async fn*`. |
| 10hh | `g.return` via `Symbol.iterator` in i fortsatt `yield*` efter send utan iterator-`return` | ✅ **kab-only** | factory-iterator; `g.return(3)` ger inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_ok` → **1479**). Inte `async fn*`. |
| 10hi | femte `.next()` efter `g.return` via `Symbol.iterator` efter send utan iterator-`return` | ✅ **kab-only** | efter **1479**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_next_ok` → **14798**). Inte `async fn*`. |
| 10hj | `g.return` in i fortsatt `yield*` efter send med iterator-`return()` `{ done: false }` | ✅ **kab-only** | efter **1**, **4**, **7**; `g.return(3)` yieldar **3** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_ok` → **1473**). Inte `async fn*`. |
| 10hk | femte `.next()` efter `g.return` efter send med iterator-`return()` `{ done: false }` | ✅ **kab-only** | efter **1473**; inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_next_ok` → **14739**). Inte `async fn*`. |
| 10hl | `g.return` via `Symbol.iterator` efter send med iterator-`return()` `{ done: false }` | ✅ **kab-only** | factory-iterator; `g.return(3)` yieldar **3** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_ok` → **1473**). Inte `async fn*`. |
| 10hm | femte `.next()` efter `g.return` via `Symbol.iterator` efter send med iterator-`return()` | ✅ **kab-only** | efter **1473**; inner `yield 9` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_next_ok` → **14739**). Inte `async fn*`. |
| 10hn | sjätte `.next()` efter `g.return` efter send med iterator-`return()` `{ done: false }` | ✅ **kab-only** | efter **14739**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_next6_ok` → **147398**). Inte `async fn*`. |
| 10ho | sjätte `.next()` efter `g.return` via `Symbol.iterator` efter send med iterator-`return()` | ✅ **kab-only** | efter **14739**; yttre `yield 8` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_next6_ok` → **147398**). Inte `async fn*`. |
| 10hp | sjunde `.next()` `done` efter custom send+`return()`-kedja | ✅ **kab-only** | efter **147398**; sjunde `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_next7_ok` → **1473981**). Inte `async fn*`. |
| 10hq | sjunde `.next()` `done` via `Symbol.iterator` efter samma kedja | ✅ **kab-only** | efter **147398**; sjunde `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_next7_ok` → **1473981**). Inte `async fn*`. |
| 10hr | `g.throw` efter completion av custom send+`return()`-kedja | ✅ **kab-only** | `g.throw(5)` yieldar **5** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_throw_done_ok` → **1473985**). Inte `async fn*`. |
| 10hs | `g.throw` efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.throw(5)` yieldar **5** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_throw_done_ok` → **1473985**). Inte `async fn*`. |
| 10ht | `g.return` efter completion av custom send+`return()`-kedja | ✅ **kab-only** | `g.return(6)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_return_done_ok` → **1473981**). Inte `async fn*`. |
| 10hu | `g.return` efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.return(6)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_return_done_ok` → **1473981**). Inte `async fn*`. |
| 10hv | extra `.next()` efter `g.throw` efter completion | ✅ **kab-only** | efter `g.throw(5)`; extra `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_throw_done_next_ok` → **1473981**). Inte `async fn*`. |
| 10hw | extra `.next()` efter `g.throw` efter completion via `Symbol.iterator` | ✅ **kab-only** | efter `g.throw(5)`; extra `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_throw_done_next_ok` → **1473981**). Inte `async fn*`. |
| 10hx | extra `.next()` efter `g.return` efter completion | ✅ **kab-only** | efter `g.return(6)`; extra `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_return_done_next_ok` → **1473981**). Inte `async fn*`. |
| 10hy | extra `.next()` efter `g.return` efter completion via `Symbol.iterator` | ✅ **kab-only** | efter `g.return(6)`; extra `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_return_done_next_ok` → **1473981**). Inte `async fn*`. |
| 10hz | `g.throw` efter extra `.next()` efter `g.throw` efter completion | ✅ **kab-only** | `g.throw(2)` yieldar **2** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_throw_done_next_throw_ok` → **1473982**). Inte `async fn*`. |
| 10ia | `g.throw` efter extra `.next()` efter `g.throw` efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.throw(2)` yieldar **2** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_throw_done_next_throw_ok` → **1473982**). Inte `async fn*`. |
| 10ib | `g.return` efter extra `.next()` efter `g.return` efter completion | ✅ **kab-only** | `g.return(2)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_return_done_next_return_ok` → **1473981**). Inte `async fn*`. |
| 10ic | `g.return` efter extra `.next()` efter `g.return` efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.return(2)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_return_done_next_return_ok` → **1473981**). Inte `async fn*`. |
| 10id | `g.throw` efter extra `.next()` efter `g.return` efter completion | ✅ **kab-only** | `g.throw(2)` yieldar **2** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_return_done_next_throw_ok` → **1473982**). Inte `async fn*`. |
| 10ie | `g.throw` efter extra `.next()` efter `g.return` efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.throw(2)` yieldar **2** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_return_done_next_throw_ok` → **1473982**). Inte `async fn*`. |
| 10if | `g.return` efter extra `.next()` efter `g.throw` efter completion | ✅ **kab-only** | `g.return(2)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_throw_done_next_return_ok` → **1473981**). Inte `async fn*`. |
| 10ig | `g.return` efter extra `.next()` efter `g.throw` efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.return(2)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_throw_done_next_return_ok` → **1473981**). Inte `async fn*`. |
| 10ih | `g.next(v)` send efter completion | ✅ **kab-only** | `g.next(6)` `done: true`; inte send-värdet (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_send_done_ok` → **1473981**). Inte `async fn*`. |
| 10ii | `g.next(v)` send efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.next(6)` `done: true`; inte send-värdet (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_send_done_ok` → **1473981**). Inte `async fn*`. |
| 10ij | extra `.next()` efter `g.next(v)` send efter completion | ✅ **kab-only** | extra `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_send_done_next_ok` → **1473981**). Inte `async fn*`. |
| 10ik | extra `.next()` efter `g.next(v)` send efter completion via `Symbol.iterator` | ✅ **kab-only** | extra `.next()` `done: true` (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_send_done_next_ok` → **1473981**). Inte `async fn*`. |
| 10il | `g.throw` efter extra `.next()` efter `g.next(v)` send efter completion | ✅ **kab-only** | `g.throw(2)` yieldar **2** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_send_done_next_throw_ok` → **1473982**). Inte `async fn*`. |
| 10im | `g.throw` efter extra `.next()` efter `g.next(v)` send efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.throw(2)` yieldar **2** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_send_done_next_throw_ok` → **1473982**). Inte `async fn*`. |
| 10in | `g.return` efter extra `.next()` efter `g.next(v)` send efter completion | ✅ **kab-only** | `g.return(2)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_send_done_next_return_ok` → **1473981**). Inte `async fn*`. |
| 10io | `g.return` efter extra `.next()` efter `g.next(v)` send efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.return(2)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_send_done_next_return_ok` → **1473981**). Inte `async fn*`. |
| 10ip | `g.throw` direkt efter `g.next(v)` send efter completion | ✅ **kab-only** | `g.throw(2)` yieldar **2** (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_send_done_throw_ok` → **1473982**). Inte `async fn*`. |
| 10iq | `g.throw` direkt efter `g.next(v)` send efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.throw(2)` yieldar **2** (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_send_done_throw_ok` → **1473982**). Inte `async fn*`. |
| 10ir | `g.return` direkt efter `g.next(v)` send efter completion | ✅ **kab-only** | `g.return(2)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_custom_throw_done_false_continue_send_return_method_send_done_return_ok` → **1473981**). Inte `async fn*`. |
| 10is | `g.return` direkt efter `g.next(v)` send efter completion via `Symbol.iterator` | ✅ **kab-only** | `g.return(2)` `done: true`; inte `null`-value (`sh6_self_host_generator_nested_try_yield_star_symbol_iterator_throw_done_false_continue_send_return_method_send_done_return_ok` → **1473981**). Inte `async fn*`. |
