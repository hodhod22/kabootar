...
| **Nästa kod** | Byta `http_fetch_async` till Kab-TLS (inte rustls). TLS 1.2 fixture-handshake och strikt PEM/Base64-gate är verifierade i Kab; nästa gate är DER/X.509 trust-chain och live handshake i Kab. |
