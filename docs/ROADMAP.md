...
| **Nästa kod** | Byta `http_fetch_async` till Kab-TLS (inte rustls). TLS 1.2 fixture-handshake och PEM-envelope-gate är verifierade i Kab; nästa gate är live handshake och trust-chain i Kab. |
