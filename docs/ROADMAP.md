...
| **F10** | **AOT + PGO** — warmed image; profilstyrd JIT/AOT | kallstart + steady-state gates | ✅ subset: x64/arm64 ship/ret-op/text/rodata/data/layout plus emit/load/verify native, write/read bind, and loaded native round/reject; native machine-code deepen |
