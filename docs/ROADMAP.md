...
| **F10** | **AOT + PGO** — warmed image; profilstyrd JIT/AOT | kallstart + steady-state gates | ✅ subset: warm/PGO/image/cold/steady + complete target/ABI/entry/page image-plan round-trip and mismatch rejection in Kab; native emit deepen |
