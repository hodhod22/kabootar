...
| **Nästa kod** | SH5: försiktig, stegvis reverse-densify av stora parser/emit-blad utan att bryta `sh6_self_host_*`. FT/JIT: SH17-ytan komplett pre-SH28 (planner, 31 guest-templater inkl. f64+SIMD, fyra fusioner + dispatcher, hotness, IC, OSR, deopt, spec, bridge, capstone) — nästa steg är SH18 GC-deepen. Nästa gate: SH28 arkivera `src/` när alla bootstrap/AOT/no-rustc gater passerar. |
