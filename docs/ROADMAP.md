...
| **Nästa kod** | Byta `http_fetch_async` till Kab-TLS (inte rustls). TLS 1.2 fixture-handshake samt PEM/Base64→DER-TLV är verifierade i Kab; nästa gate är X.509 issuer/signatur-trust-chain och live handshake i Kab. |
