...
**Nu:** SH20–SH28 delete-gate deepen (`nollLspIsKab` efter `nollFmtIsKab`) + SH27 kbrowser deepen (`uiIsMesh` efter `uiIsSolidColor`). Våg FT F18–F24 subset landad. Planer: [egna fötter](#kabootar-på-egna-fötter--noll-rust) · [fart](#våg-ft--fart-alla-tekniker-i-kab).
...
**Nästa:** SH28 noll deepen (nästa leaf efter noll_lsp: nollDocIsKab). SH27 kbrowser deepen. SH20–SH28 delete-gate deepen (alla gates fortfarande `false`). Se [Kabootar på egna fötter](#kabootar-på-egna-fötter--noll-rust) och [Våg FT](#våg-ft--fart-alla-tekniker-i-kab). **Dok:** ROADMAP + `self_host/README.md` efter varje pass.
