...
**Checkpoint SC (nästa):** einsum optimize path; truncated SVD streaming; dual-tree complex wavelet; sparse LU/Cholesky fill-reducing; full MHA HOAD; FEM Neumann/Robin BC.
