...
**Nästa:** SH20–SH28 delete-gate deepen (alla gates fortfarande `false`); SH27 UI dual-bind deepen (nästa leaf efter ui_center: uiIsNobr). Se [Kabootar på egna fötter](#kabootar-på-egna-fötter--noll-rust). **Dok:** ROADMAP + `self_host/README.md` efter varje pass.
