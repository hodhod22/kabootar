...
| **Nästa kod** | Byta `http_fetch_async` till Kab-TLS (inte rustls). TLS 1.2 fixture-handshake samt PEM/Base64→DER-bytes är verifierade i Kab; nästa gate är DER-TLV/X.509 trust-chain och live handshake i Kab. |
