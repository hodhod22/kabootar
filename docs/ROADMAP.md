...
| **F10** | **AOT + PGO** — warmed image; profilstyrd JIT/AOT | kallstart + steady-state gates | ✅ subset: first-image ship plus `aotRetOp`/`aotLoadRetOk`; native machine-code deepen |
