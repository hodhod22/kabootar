...
**Nu:** SH20–SH28 delete-gate deepen (`stdColExp` efter `stdColLog10`) + SH27 kbrowser deepen (`uiIsEq` landad). Våg FT F18–F24 subset landad. Planer: [egna fötter](#kabootar-på-egna-fötter--noll-rust) · [fart](#våg-ft--fart-alla-tekniker-i-kab).
...
**Nästa:** SH20 collections deepen (nästa leaf efter std_colexp: stdColSin). SH27 kbrowser deepen. SH20–SH28 delete-gate deepen (alla gates fortfarande `false`). Se [Kabootar på egna fötter](#kabootar-på-egna-fötter--noll-rust) och [Våg FT](#våg-ft--fart-alla-tekniker-i-kab). **Dok:** ROADMAP + `self_host/README.md` efter varje pass.
