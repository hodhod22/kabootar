...
| **F10** | **AOT + PGO** — warmed image; profilstyrd JIT/AOT | kallstart + steady-state gates | ✅ subset: x64/arm64 ship/ret-op plus emit/load/verify/write/read/loaded text (RWX reject); native machine-code deepen |
